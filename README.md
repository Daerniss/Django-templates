...
```
After that you will see coverage report just below tests results. Also you can get access to HTML version of the report on [pages](https://frontend_internship_templates_traning.git.steelkiwi.com/backend/)
...
``` 
Manually move `app_name` folder to `frontend_internship_templates_traning/apps/`
```bash
$ mv app_name frontend_internship_templates_traning/apps/
```
